      ...
      <form className="flex flex-col justify-center items-center w-1/4 absolute bg-black/80 px-11 pt-11 pb-40 rounded-lg top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        {!isSignIn && (
          <input
            ...
            className="w-full py-2 px-2 m-2 rounded outline-none border border-white  bg-black/10 p-6  placeholder:text-gray-300 placeholder:text-sm placeholder:italic"
          />
        )}
        <input
        ...
        <button
          ...
          className="text-white w-full  py-1 px-2 m-2 rounded cursor-pointer bg-red-600"
        >
        ...
        <div>
          <p className="text-white text-sm mt-2">
            New to Netflix?{" "}
            <span className="text-bold text-white ">Sign up now</span>
          </p>
        </div>
      </form>
    </div>
